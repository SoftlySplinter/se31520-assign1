Csa::Application.configure do
  ...
  # Tell Peperclip where to look for graphic manipulation commands
  Paperclip.options[:command_path] = "/usr/local/bin/"  # Change this to the ImageMagick etc installation
end
